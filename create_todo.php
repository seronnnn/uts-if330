...
<body class="flex items-center justify-center min-h-screen bg-gradient-to-r from-green-400 to-blue-500 p-4 sm:p-8">
    <div class="bg-white p-6 sm:p-8 rounded-lg shadow-lg max-w-md w-full">
        <h2 class="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-center text-blue-600">Create New To-Do List</h2>
